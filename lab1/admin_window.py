...
class Window2(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("You are logged in as an administrator")

        self.label_2 = QLabel(self)
        self.label_2.setText("Admin can read, write and execute (rwx)")
    ...
    def rm(self):
        try:
            ...
            try:
                ...
                self.error("A file or directory in the path name does not exist!")
